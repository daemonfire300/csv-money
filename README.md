...
It has an amount of dependencies that is almost too much for the basic functionality of a tempdir.
...
For my work in progress tiny systemd-creds helper lib I went and copied nightly (not sure if it's still nighlty now) rust std code instead and build only the required parts I need for a tempdir. [https://github.com/daemonfire300/systemd-creds-rs/blob/master/src/lib.rs#L87-L136](https://github.com/daemonfire300/systemd-creds-rs/blob/master/src/lib.rs#L87-L136)
